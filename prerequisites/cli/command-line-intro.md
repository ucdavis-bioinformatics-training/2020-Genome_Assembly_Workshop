...
/share/workshop/genome_assembly//msettles/cli
...
**relative** (start here, take two steps up, then down through share and workshop)
    ...
    cd ../../share/workshop/genome_assembly/
    pwd
...
<div class="output">msettles@tadpole:/share/workshop/genome_assembly/msettles/cli$ ./test.sh genome.fa
    1686 T
    1292 A
    1253 G
    1155 C
